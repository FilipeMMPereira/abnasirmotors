        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Province {{$province->province}}</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="province" placeholder="Province" name="province" value="{{old('province')??$province->province}}">
